...
*ADDED TOS - All tools available require attribution to [0xReconLion or ReconLion] if used. Failure to attribute within a saleable setting can result in penalty if found to not have proper attribution to 0xReconLion/ReconLion or the developer branch you are using. 

Encouragement of learning, exploration, hacking, and use is HIGHLY RECOMMENDED.

Attribution is required. The license notice is required.
